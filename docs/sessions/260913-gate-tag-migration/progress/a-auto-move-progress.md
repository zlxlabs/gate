...
- 验证：最终全量测试 953 passed（默认 Python 3.14 环境 42.79s，Python 3.12 32.69s）；新增测试 8 passed；`actionlint .github/workflows/v2-tag-sync.yml` 与 `python3 scripts/check_pinned_uses.py` 均通过。
